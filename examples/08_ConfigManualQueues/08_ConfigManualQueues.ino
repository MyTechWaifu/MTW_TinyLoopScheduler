...
/*
  ...
  Manual queue configuration used by this example:
    ...
    Queue           Physical capacity   Used by this sketch
  ...
  sketch. Hardware interrupt handling was demonstrated in the previous
  ISR Post Task example.

  Try different queue capacities:
    1. change one or more TLS_MAX_* values below;
    2. compile the sketch again;
    3. compare SRAM usage in the Arduino IDE build report;
...
/*
  ...
  Each queue has two physical slots. This sketch uses no more than one
