...
/*
  ...
  Try both configurations:
    ...
    2. build the project;
    3. note the SRAM usage in the PlatformIO build output;
    4. switch to the other value;
    5. build the project again and compare the result.
  ...
  Important:
    ...
    - changing TLS_PERIOD requires rebuilding the project;
