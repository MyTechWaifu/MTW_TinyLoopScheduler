...
/*
  ...
  Try different profiles:
    ...
    2. build and upload the project again;
    3. compare SRAM and Flash usage in the PlatformIO build output;
  ...
  Important:
    ...
    - changing the profile requires rebuilding the project;
...
/*
  ...
  Leave only one line enabled. Then build the project again and compare
  memory usage in the PlatformIO build output.
